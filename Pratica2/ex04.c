...
int main(){
    ...
    printf("Valor total dos impostos: R$ %.2f", precof-preco);
    //Como fiquei em duvida sobre o que era o imposto, fiz o preço total menos o unitario
